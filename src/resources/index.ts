...
export function registerResources(server: McpServer): void {
  ...
  server.resource(
    ...
    { description: 'All VDXF key i-addresses across agent, service, review, platform, and session groups. On-chain data uses nested DataDescriptor format under parent keys.' },
    async () => ({
      contents: [{
